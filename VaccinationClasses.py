...
Date: 01/20/2024
Assignment Title: Vaccinations Tracking OOP Assignment 2- classes
"""


class Person:
    def __init__(self, name, vac_a, vac_b, vac_c, symp_a1, symp_a2, symp_a3, symp_b1, symp_b2, symp_b3, symp_c1,
                 symp_c2, symp_c3):
        self.name = name
    ...
    def __str__(self):
        ...
        return (f"Person(Name: {self.name}, vac_a: {self.vac_a}, vac_b: {self.vac_b}, vac_c: {self.vac_c}, "
                f"symp_a1: {self.symp_a1}, symp_a2: {self.symp_a2}, symp_a3: {self.symp_a3}, symp_b1: {self.symp_b1}, "
                f"symp_b2: {self.symp_b2}, symp_b3: {self.symp_b3}, symp_c1: {self.symp_c1}, symp_c2: {self.symp_c2}, "
                f"symp_c3: {self.symp_c3})")
